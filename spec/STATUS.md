...
| [QR-TEXT](qr.md#qr-text)                     | done    | —       | [Text.pm](../lib/App/FuguSeed/Text.pm) renders the grid view and the zone views, and [QR.pm](../lib/App/FuguSeed/QR.pm) holds the pause. [qr.t](../t/fuguseed/qr.t) holds both views to the fixture.                       |
...
| [TEST-QR](testing.md#test-qr)                | done    | —       | [qr.t](../t/fuguseed/qr.t) holds the two test vectors, and the codewords, the matrix and the views of test vector 4.                                                                                                       |
