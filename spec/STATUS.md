...
| [LIST-SHARE](list.md#list-share)             | partial | —       | [english.txt](../share/fuguseed/english.txt) holds LIST-SHARE-1. LIST-SHARE-2 waits on WORDS-BUILD, and LIST-SHARE-3 waits on WORDS-CHECK.    |
